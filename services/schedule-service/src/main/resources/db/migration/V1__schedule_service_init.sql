...
CREATE INDEX idx_dentists_specialty ON dentists(specialty);
...
CREATE INDEX idx_working_hours_dentist ON dentist_working_hours(dentist_id, day_of_week);
...
CREATE INDEX idx_slots_date_status  ON dentist_slots(slot_date, display_status);
